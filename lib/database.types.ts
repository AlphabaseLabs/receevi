  ...
  public: {
    Tables: {
      ...
      broadcast: {
        ...
        Relationships: [
          {
            foreignKeyName: "broadcast_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broadcast_batch: {
        ...
        Relationships: [
          {
            foreignKeyName: "broadcast_batch_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      broadcast_contact: {
        ...
        Relationships: [
          {
            foreignKeyName: "broadcast_contact_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      contact_tag: {
        ...
        Relationships: [
          {
            foreignKeyName: "contact_tag_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Enums: {
      ...
      message_sender_type: "customer" | "bot" | "agent" | "coexistence"
